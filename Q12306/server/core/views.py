...
from Q12306.server.core.parser import get_start_requests
from Q12306.server.core.response import JsonResponse
from Q12306.cmd.init import PROJECTS_FOLDER
from Q12306.server.server.settings import TIME_ZONE
from Q12306.server.core.models import Client, Project, Deploy, Monitor, Task
from Q12306.server.core.build import build_project, find_egg
from Q12306.server.core.utils import IGNORES, is_valid_name, copy_tree, TEMPLATES_DIR, TEMPLATES_TO_RENDER, \
...
from Q12306.server.core import parser
...
def project_configure(request, project_name):
    ...
    # update configuration
        ...
        cmd = ' '.join(['Q12306', 'generate', project_name])
...
def project_parse(request, project_name):
    ...
    if request.method == 'POST':
        ...
        print(args_cmd)
        cmd = 'Q12306 parse {args_cmd} {project_path} {spider_name}'.format(
            args_cmd=args_cmd,
