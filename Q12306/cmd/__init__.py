from Q12306 import version
from Q12306.cmd.init import init
from Q12306.cmd.parse import parse
from Q12306.cmd.generate import generate
from Q12306.server.manage import manage
import argparse
...
parser_init.add_argument('folder', default='Q12306', nargs='?', type=str, help='initial workspace folder')
